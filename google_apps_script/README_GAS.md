...
Google Sheet Master DB: [ฐานข้อมูลสมาชิกแพทย์เวชศาสตร์ครอบครัว_MasterDB_2026](https://docs.google.com/spreadsheets/d/18sXvaCY6aP7SsN5Ak6DWWDNzQRhcC1YN/edit?usp=drive_link)
...
4. ลบโค้ดเดิมในไฟล์ `Code.gs` แล้วนำโค้ดจากไฟล์ `Code.gs` ในโฟลเดอร์นี้ไปวางแทนที่ทั้งหมด (เชื่อมโยงกับ Master DB ID: `18sXvaCY6aP7SsN5Ak6DWWDNzQRhcC1YN`)
